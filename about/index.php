...
<a href="/forum/"> <link rel="icon" type="image/x-icon" href="/assets/favicon.ico"> </a>
    ...
    <p>Now, when Miguel and Francisco, along with their long-time collaborator Tomás Cruz were tasked to build a website for the curricular unit of Information Systems Engineering, it was a no-brainer to use this opportunity to bring web-JOnAS to a new level, mixing legacy features such as the question leaderboard, with new ones like the question forums.</p>
